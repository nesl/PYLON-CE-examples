...
class BruteForceSolver(Solver):
    ...
    def all_samples(self, log_probs):
        ...
        for i in range(llgprbs):
            # print(torch.tensor([5])*[torch.arange(shapes[i][-1])], "shape[i][1:-1]")
